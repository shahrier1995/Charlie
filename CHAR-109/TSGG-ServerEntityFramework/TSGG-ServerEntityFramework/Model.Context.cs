...
namespace TSGG_ServerEntityFramework
{
    ...
    public partial class TSGGEntities : DbContext
    {
        public TSGGEntities()
            : base("name=TSGGEntities")
        {
        }
        ...
        public virtual DbSet<tbl_CardList> tbl_CardList { get; set; }
        ...
        public virtual DbSet<tbl_IsCardExist> tbl_IsCardExist { get; set; }
